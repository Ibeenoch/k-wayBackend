...
import { changePassword, editProfile, getFollowers, getFollowing, login, recoveryEmailLink, register, userFollowers, userFollowing, verifyEmail } from '../controllers/user.js';
